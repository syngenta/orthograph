"""Tests for orthograph.extensions.neo4j.inspector."""
...
def test_neo4j_inspect_produces_profile() -> None:
    ...
    assert person.property_profiles["name"].is_mandatory is True
...
def test_neo4j_validate_database(model: GraphDataModel) -> None:
    driver = MagicMock()
