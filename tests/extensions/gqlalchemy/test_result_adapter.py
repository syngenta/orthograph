...
class TestGqaNodeToDict:
    ...
    def test_node_to_dict_basic(self, model: GraphDataModel) -> None:
        ...
        result = gqa_node_to_dict(mock_node, model)
        assert result["__label__"] == "Person"
        assert result["name"] == "Alice"
        assert result["age"] == 30

    def test_node_to_dict_with_optional_property(self, model: GraphDataModel) -> None:
        from orthograph.extensions.gqlalchemy.result_adapter import (
            gqa_node_to_dict,
        )
    ...
    def test_node_to_dict_no_matching_label(self, model: GraphDataModel) -> None:
        from orthograph.extensions.gqlalchemy.result_adapter import (
            gqa_node_to_dict,
        )
...
class TestGqaRelationshipToDict:
    ...
    def test_rel_to_dict_basic(self, model: GraphDataModel) -> None:
        from orthograph.extensions.gqlalchemy.result_adapter import (
        ...
        result = gqa_relationship_to_dict(mock_rel, model)
        assert result["__label__"] == "ACTED_IN"
        assert result["role"] == "Neo"
        assert "__source_uid__" in result
        assert "__target_uid__" in result

    def test_rel_to_dict_without_properties(self, model: GraphDataModel) -> None:
        from orthograph.extensions.gqlalchemy.result_adapter import (
            gqa_relationship_to_dict,
        )
...
class TestGqaResultsToGraphData:
    ...
    def test_extracts_nodes_from_results(self, model: GraphDataModel) -> None:
        from orthograph.extensions.gqlalchemy.result_adapter import (
    ...
    def test_extracts_relationships_from_results(self, model: GraphDataModel) -> None:
        from orthograph.extensions.gqlalchemy.result_adapter import (
            gqa_results_to_graph_data,
        )
    ...
    def test_mixed_nodes_and_rels(self, model: GraphDataModel) -> None:
        from orthograph.extensions.gqlalchemy.result_adapter import (
            gqa_results_to_graph_data,
        )
    ...
    def test_skips_scalar_values(self, model: GraphDataModel) -> None:
        from orthograph.extensions.gqlalchemy.result_adapter import (
            gqa_results_to_graph_data,
        )
...
class TestValidateGqaResult:
    ...
    def test_valid_node_result(self, model: GraphDataModel) -> None:
        from orthograph.extensions.gqlalchemy.result_adapter import (
            validate_gqa_result,
        )
        ...
        results: list[dict[str, Any]] = [{"p": mock_node}]
        vr = validate_gqa_result(results, model)
        assert vr.is_valid

    def test_invalid_node_result_missing_property(self, model: GraphDataModel) -> None:
        from orthograph.extensions.gqlalchemy.result_adapter import (
            validate_gqa_result,
        )
    ...
    def test_unknown_label_in_result(self, model: GraphDataModel) -> None:
        from orthograph.extensions.gqlalchemy.result_adapter import (
            validate_gqa_result,
        )
