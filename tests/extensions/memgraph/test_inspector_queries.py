"""Tests for orthograph.extensions.memgraph.queries (E17 T7/T8).
...
from orthograph.extensions.models import CardinalityStats
from orthograph.extensions.neo4j.queries import EndpointLabelsRow
