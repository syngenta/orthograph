...
class TestGqlAlchemySchema:
    ...
    def test_get_node_class_returns_correct_class(
        self, filmography_model: GraphDefinition
    ) -> None:
...
class TestNodeClassGeneration:
    ...
    def test_generated_node_without_properties(
        self, simple_model: GraphDefinition
    ) -> None:
        from orthograph.backends.gqlalchemy.codegen import (
            generate_gqlalchemy_classes,
        )
...
class TestRelationshipClassGeneration:
    ...
    def test_generated_rel_with_optional_properties(
        self, friendship_model: GraphDefinition
    ) -> None:
        from orthograph.backends.gqlalchemy.codegen import (
            generate_gqlalchemy_classes,
        )
...
class TestTypeTranslation:
    ...
    def test_str_type_preserved(self, filmography_model: GraphDefinition) -> None:
        from orthograph.backends.gqlalchemy.codegen import (
            generate_gqlalchemy_classes,
        )
    ...
    def test_int_type_preserved(self, filmography_model: GraphDefinition) -> None:
        from orthograph.backends.gqlalchemy.codegen import (
            generate_gqlalchemy_classes,
        )
    ...
    def test_optional_type_preserved(self, filmography_model: GraphDefinition) -> None:
        from orthograph.backends.gqlalchemy.codegen import (
            generate_gqlalchemy_classes,
        )
...
class TestCodegenEdgeCases:
    ...
    def test_generate_is_idempotent(self, filmography_model: GraphDefinition) -> None:
