"""GraphDataModel -- container for graph data structure definition."""
...
class GraphDataModel:
    """Container defining graph structure: node types, relationship types, constraints.

    Validates structural consistency on creation. Provides lookup and
    introspection methods for use by validators and extensions.
    """
    ...
    def validate_structure(self) -> ValidationResult:
        """Validate structural consistency. Returns result with any issues."""
    ...
    def _check_isolated_nodes(self, result: ValidationResult) -> None:
        ...
        for rt in self.relationship_types:
            connected.add(rt.__source_type__.__label__)
            connected.add(rt.__target_type__.__label__)
