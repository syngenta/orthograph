...
This is the registry half of STEP 3. It does not execute anything — execution is
the Executor's job (``orthograph.catalogue.typed``). The catalogue only registers
and introspects.
"""
