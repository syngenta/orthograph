...
| E61 | Documentation — Read the Docs Site (Diátaxis × Three Audiences) | High | planned (ADR-046; supersedes E3; phased P0–P4 — P0 walking skeleton is a review gate; notebooks compiled in place as the single tutorial source via myst-nb; reference = 7 root modules + `cypher/`; pydata-sphinx-theme + RTD; delegation-ready tasks tagged opus/sonnet/haiku/qwen)                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
