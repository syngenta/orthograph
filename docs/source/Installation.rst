...
orthograph requires python 3.9 or higher, as well as some common and reliable third party packages
...
packages. To install orthograph in development setting simply type:
